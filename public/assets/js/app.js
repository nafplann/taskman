...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dashboard__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__project__ = __webpack_require__(6);
...
window.App = __WEBPACK_IMPORTED_MODULE_0__helper__["a" /* default */];
window.Dashboard = __WEBPACK_IMPORTED_MODULE_1__dashboard__["a" /* default */];
window.Project = __WEBPACK_IMPORTED_MODULE_2__project__["a" /* default */];
...
var App = {
    ...
    loading: function loading() {
        ...
        state ? $('#main-preloader').removeClass('hidden') : $('#main-preloader').addClass('hidden');
    },
    ...
    loadModal: function loadModal() {
        ...
        var backdrop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'static';
    ...
    enable: function enable(element) {
        element.removeClass('is-loading').attr('disabled', false);
    },
    disable: function disable(element) {
        element.addClass('is-loading').attr('disabled', true);
    },
    disableSubmit: function disableSubmit(form) {
        form.find('button[type="submit"]').addClass('m-loader m-loader--light m-loader--right').attr('disabled', true);
    },
    enableSubmit: function enableSubmit(form) {
        form.find('button[type="submit"]').removeClass('m-loader m-loader--light m-loader--right').attr('disabled', false);
    },
    ...
    alert: function alert(title, messages, type) {
    ...
    formFailed: function formFailed(form, message) {
    ...
    datatable: function datatable(element, options) {
    ...
    slimSelect: function slimSelect(element, options) {
        return new SlimSelect($.extend({
            select: element
        }, options));
    },
    daterangepicker: function daterangepicker(element, options) {
...
var Dashboard = {
    ...
    fetchProject: function fetchProject() {
        ...
        App.ajax('/projects', 'GET', 'application/json', null).then(function (results) {
            projectList.empty();
    ...
    createProject: function createProject() {
        ...
        App.ajax('/projects/create', 'GET', 'text/html', null).then(function (results) {
            modal.html(results);
        ...
        modal.on('submit', 'form', function (e) {
            ...
            App.ajaxFile(url, method, 'json', formData).fail(function (xhr) {
...
var Project = {
    show: function show() {
        ...
        $('.task-form').on('submit', function (e) {
            ...
            App.ajaxFile(url, method, 'application/json', formData).then(function (results) {
                form[0].reset();
    ...
    fetchTasks: function fetchTasks(type) {
        var id = $('#project-container').data('id');
        var container = $('#' + type + '-container');
        var lists = container.find('.dd.nestable');
        var loader = container.find('.progress');

        loader.removeClass('hidden');

        App.ajax('/tasks/get', 'GET', 'application/json', { id: id, type: type }).then(function (results) {
            lists.empty();
    ...
    invite: function invite() {
        ...
        App.ajax('/projects/invite', 'GET', 'text/html', null).then(function (results) {
            modal.html(results);
        });
